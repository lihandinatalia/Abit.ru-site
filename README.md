# Корпоративный сайт ООО «Абит» (Abit.ru-site)

## Название проекта

Корпоративный многостраничный сайт IT-компании **ООО «Абит»** — сервис IT-сопровождения и инфраструктуры под ключ.

## Решаемая задача

Создать современное цифровое представление компании, которое:
...
- **Основной:** руководители, собственники и IT-директора средних и крупных компаний, а также специалисты по закупкам, ищущие подрядчика для IT-аутсорсинга, сопровождения инфраструктуры или импортозамещения.
- **Вторичный:** существующие клиенты и партнёры, которым нужны контакты, информация об услугах или политика конфиденциальности.
